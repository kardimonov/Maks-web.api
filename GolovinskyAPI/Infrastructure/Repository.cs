...
using GolovinskyAPI.Models.ViewModels;
...
namespace GolovinskyAPI.Infrastructure
{
    public class Repository : IRepository
    {
        ...
        public SearchPictureInfoOutputModel SearchPictureInfo(SearchPictureInfoInputModel input)
        {
            ...
            if (res != null)
            {
                res.AdditionalImages = GetAllAdditionalPictures(input);
        ...
        public LoginAdminOututModel CheckWebPasswordAdmin(LoginModel input)
        {
            LoginAdminOututModel res;
            using (IDbConnection db = new SqlConnection(connection))
            {
                var response = db.Query<LoginAdminOututModel>("sp_CheckWebPasswordAdmin",
